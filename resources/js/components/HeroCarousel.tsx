...
export default function HeroCarousel() {
    ...
    return (
        ...
        <div className="relative w-full min-h-[400px] md:min-h-[400px]">
                    ...
                    <div className={`relative h-full overflow-hidden rounded-3xl shadow-2xl ${slide.bg}`}>
                        ...
                        <div className="relative z-10 flex h-full flex-col items-center justify-center gap-8 px-8 py-8 text-center md:flex-row md:justify-between md:gap-12 md:px-16 md:py-0 md:text-left">
                            ...
                            <motion.div
                                ...
                                className="max-w-2xl"
                            >
                                <h1 className="mb-4 text-4xl font-extrabold leading-tight text-white sm:text-5xl md:mb-6 md:text-6xl">
                                    {slide.title}
                                </h1>
                                ...
                                <div className="flex flex-col justify-center gap-4 sm:flex-row md:justify-start">
                                    ...
                                    <button className="rounded-xl border-2 border-white/40 px-8 py-4 text-lg font-semibold text-white backdrop-blur-sm transition-all duration-300 hover:scale-105 hover:bg-white/10 hover:border-white/60">
                                        Lanjut Belanja
                                    </button>
                                </div>
                            </motion.div>
