...
export default function CategoryFormModal({ isOpen, onClose, onSubmit, category }: CategoryFormModalProps) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div className="relative mx-4 max-h-[90vh] w-full max-w-md overflow-y-auto rounded-lg bg-white shadow-xl backdrop-blur-lg dark:bg-zinc-700/90">
                ...
                <form onSubmit={handleSubmit} className="space-y-4 p-6">
                    ...
                    <div>
                        ...
                        <Input id="main_category" name="main_category" value={formData.main_category} onChange={handleInputChange} required />
                    </div>

                    {/* Subcategory 1 */}
                    <div>
                        <Label htmlFor="subcategory1">Subcategory 1</Label>
                        <Input id="subcategory1" name="subcategory1" value={formData.subcategory1} onChange={handleInputChange} />
                    </div>

                    {/* Subcategory 2 */}
                    <div>
                        <Label htmlFor="subcategory2">Subcategory 2</Label>
                        <Input id="subcategory2" name="subcategory2" value={formData.subcategory2} onChange={handleInputChange} />
                    </div>
