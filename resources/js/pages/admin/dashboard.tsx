    ...
    const renderNotificationIcon = () => (
        <div className="fixed top-16 right-6 z-50">
            <div className="relative">
                <button onClick={() => setOpen(!open)} className="relative rounded-full bg-background p-2 shadow-md hover:bg-accent">
                ...
                {open && (
                    <div className="absolute right-0 mt-2 w-64 overflow-hidden rounded-lg border border-border bg-white shadow-lg dark:bg-gray-900">
                        <div className="border-b border-border p-3 text-sm font-semibold">Notifikasi</div>

                        {unread > 0 ? (
                            <div className="space-y-2 p-3">
                                <div className="text-sm text-foreground">📦 {unread} order baru belum dibaca</div>
                                <a
                            ...
                            <div className="p-3 text-sm text-muted-foreground">Tidak ada notifikasi baru</div>
                        )}
                    </div>
                )}
            </div>
    ...
    const renderQuickActions = () => (
        <Card className="border border-border bg-card p-6">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                <a href={route('admin.users.index')} className="block rounded-lg border border-border p-4 transition-colors hover:bg-accent">
                ...
                <a href={route('admin.roles.index')} className="block rounded-lg border border-border p-4 transition-colors hover:bg-accent">
                ...
                <a href={route('admin.permissions.index')} className="block rounded-lg border border-border p-4 transition-colors hover:bg-accent">
