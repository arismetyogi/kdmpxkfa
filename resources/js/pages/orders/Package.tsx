    ...
    setPackageProducts(prevProducts => 
      prevProducts.map(product => 
        product.id === productId 
          ? { ...product, assignedQuantity: Math.max(1, Math.min(newQuantity, product.maxQuantity)) } 
          : product
      )
    );
  };
              ...
              <CardContent className="p-6">
                <div className="mb-4">
                  ...
                  <p className="mt-2 text-gray-600 dark:text-gray-300">
                    A comprehensive package of essential health products for your family. 
                    This package includes vitamins, supplements, and common medications.
                    You can adjust the quantity of each product between 1 and the maximum limit.
                  </p>
                </div>
              </CardContent>
            </Card>
                          ...
                          <div className="mt-4 sm:mt-0 flex items-center">
                            <div className="flex items-center border border-gray-300 rounded-md">
                              <button
                                ...
                                className={`p-2 ${product.assignedQuantity <= 1 
                              ...
                              <button
                                ...
                                className={`p-2 ${product.assignedQuantity >= product.maxQuantity 
                                  ? 'text-gray-300 cursor-not-allowed' 
                                  : 'text-gray-600 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700'}`}
